...
<div class="container-fluid">
    <div class="card card-default">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" maxlength="4" id="branch_code" name="branch_code" placeholder="Enter Branch Code" onfocusout ="check_duplicate_value('branch_code','branches',this.value,0);" value="" tabindex="5">
                ...
                <div class="col-md-5">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" maxlength="100" id="branch_name" name="branch_name" placeholder="Enter Branch Name" onfocusout ="check_duplicate_value('branch_name','branches',this.value,0);" value="" tabindex="6">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" maxlength="100" id="branch_title" name="branch_title" placeholder="Enter Branch Title" value="" tabindex="7">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="checkbox" tabindex="8"  name="ad_status" id="ad_status" onclick="change_ad_option();" value="0">
                ...
                <div class="col-md-4" id="ad_code_div">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" tabindex="9" name="ad_code" id="ad_code" placeholder="Enter AD Code" value="" onfocusout ="check_duplicate_value('ad_code','branches',this.value,0);"  maxlength="4">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="branch_details" maxlength="250" name="branch_details" tabindex="11" ></textarea>
        ...
        <div class="card-footer">
            <button type="button" onclick="validation();" class="btn btn-primary float-right" tabindex="12">Add Branch</button>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    ...
    load_drop_down('divisions','id,division_name','division_id','division_id_container','Select Division',0,0,0,1,'load_drop_down(\'districts\',\'id,district_name\',\'district_id\',\'district_id_container\',\'Select District\',0,0,0,2,\'load_upazila();\',\'division_id\',this.value,0,0);load_upazila();',0,0,0,0);

    load_drop_down('branches','id,branch_name','ad_branch_id','ad_branch_id_id_container','Select AD Branch',0,0,0,10,'','ad_status',1,0,0);

    load_drop_down('services','id,service_name','assign_service','assign_service_container','Select Assign Service',1,0,0,4,'',0,0,0,0);

    blank_drop_down('district_id','district_id_container','Select District',0,0,2);
    blank_drop_down('upazila_id','upazila_id_container','Select Upazila',0,0,2);
    ...
    function validation(){
        ...
        confirm_box('Add', 'Are You Sure Want To Save Branch Info?','add_data');
    }
    ...
    function add_data(){
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                all_response(response,'{{route('reference.branch.view')}}','View Branch');
            },
