        ...
        <table class="table table-bordered table-hover">
            ...
            <tbody>
                ...
                <tr data-widget="expandable-table" aria-expanded="false">
                    ...
                    <td>{{isset($history_data->upazila_name)?$history_data->upazila_name:''}}</td>
                </tr>
                <tr data-widget="expandable-table" aria-expanded="false">
                ...
                <tr data-widget="expandable-table" aria-expanded="false">
                    ...
                    <td>{{isset($history_data->branch_code)?$history_data->branch_code:''}}</td>
                </tr>
                <tr data-widget="expandable-table" aria-expanded="false">
                    <td>Branch Title</td>
                    <td>{{$single_data->branch_title}}</td>
                    <td>{{isset($history_data->branch_title)?$history_data->branch_title:''}}</td>
                </tr>
                <tr data-widget="expandable-table" aria-expanded="false">
                    <td>Branch Status</td>
                ...
                <tr data-widget="expandable-table" aria-expanded="false">
                    ...
                    <td>{{isset($history_data->ad_status)?$history_data->ad_status==1?'Yes':'No':''}}</td>
                </tr>
                <tr data-widget="expandable-table" aria-expanded="false">
                    <td>Branch AD Code</td>
                    <td>{{$single_data->ad_code}}</td>
                    <td>{{isset($history_data->ad_code)?$history_data->ad_code:''}}</td>
                </tr>
                <tr data-widget="expandable-table" aria-expanded="false">
                    <td>Details</td>
                    <td><p>{!!$single_data->branch_details!!}</p></td>
                    <td>{!!isset($history_data->branch_details)?$history_data->branch_details:''!!}</td>
                </tr>
            </tbody>
        </table>
    ...
    function send_to_checker(){
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                all_response(response,'{{route(request()->route()->getName())}}','Sent To Checker View Branch');
            },
