<div class="container-fluid">
    <div class="card card-default">
        ...
        <div class="card">
            <div class="card-body">
                <table id="service_data_table" class="table table-bordered table-striped text-center" rules="all">
                    <thead>
                        <tr>
                            ...
                            <th width="5">Code</th>
                            <th width="5">Letter</th>
                            <th width="5">Starting Number</th>
            ...
            "columns": [
                ...
                @foreach($grid_right as $right)
                {
                    ...
                    "render": function(data, type, full, meta) {
                        ...
                        var titleValue = full.service_name;
                ...
                },
                {
                    ...
                    "render": function(data, type, full, meta) {
                        ...
                        if(data!=null){
                            ...
                            return '<div class="text-left" onclick="return_message_history(\''+full.service_name+'\',\''+full.id+'\',\'services\')">'+data+'</div>';
                        }
                        else{
