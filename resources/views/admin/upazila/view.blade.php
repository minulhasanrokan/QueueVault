<div class="container-fluid">
    <div class="card card-default">
        ...
        <div class="card">
            <div class="card-body">
                <table id="upazila_data_table" class="table table-bordered table-striped text-center" rules="all">
                    <thead>
                        <tr>
            ...
            "columns": [
                ...
                @foreach($grid_right as $right)
                {
                    ...
                    "render": function(data, type, full, meta) {
                        ...
                        var titleValue = full.upazila_name;
                ...
                },
                {
                    ...
                    "render": function(data, type, full, meta) {
                        ...
                        if(data!=null){
                            ...
                            return '<div class="text-left" onclick="return_message_history(\''+full.upazila_name+'\',\''+full.id+'\',\'upazilas\')">'+data+'</div>';
                        }
                        else{
