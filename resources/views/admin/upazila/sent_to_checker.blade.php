        ...
        <table class="table table-bordered table-hover">
            ...
            <tbody>
                ...
                <tr data-widget="expandable-table" aria-expanded="false">
                    ...
                    <td>{{isset($history_data->upazila_code)?$history_data->upazila_code:''}}</td>
                </tr>
                <tr data-widget="expandable-table" aria-expanded="false">
                    <td>Upazila Title</td>
                    <td>{{$single_data->upazila_title}}</td>
                    <td>{{isset($history_data->upazila_title)?$history_data->upazila_title:''}}</td>
                </tr>
                <tr data-widget="expandable-table" aria-expanded="false">
                ...
                <tr data-widget="expandable-table" aria-expanded="false">
                    ...
                    <td>{!!isset($history_data->upazila_details)?$history_data->upazila_details:''!!}</td>
                </tr>
            </tbody>
        </table>
    ...
    function send_to_checker(){
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                all_response(response,'{{route(request()->route()->getName())}}','Sent To Checker View Upazila');
            },
