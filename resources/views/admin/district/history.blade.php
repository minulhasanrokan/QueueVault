    ...
    <div class="card card-default px-1 py-1">
        <table id="history" class="table table-bordered table-hover">
            ...
            <tbody>
                ...
                <tr data-widget="expandable-table" aria-expanded="false">
                    <td width="150">District Code</td>
                    <td width="500">{{$data->district_code}}</td>
                </tr>
                <tr data-widget="expandable-table" aria-expanded="false">
                    <td width="150">District Title</td>
                    <td width="500">{{$data->district_title}}</td>
                </tr>
                <tr data-widget="expandable-table" aria-expanded="false">
                    <td width="150">District Status</td>
                    <td width="500">{{$data_status[$data->status]}}</td>
                </tr>
                <tr data-widget="expandable-table" aria-expanded="false">
                    <td width="150">Details</td>
                    <td width="500">{!!$data->district_details!!}</td>
                </tr>
                @endforeach
            </tbody>
        </table>
