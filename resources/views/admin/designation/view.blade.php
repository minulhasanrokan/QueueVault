<div class="container-fluid">
    <div class="card card-default">
        ...
        <div class="card">
            <div class="card-body">
                <table id="designation_data_table" class="table table-bordered table-striped text-center" rules="all">
                    <thead>
                        <tr>
            ...
            "columns": [
                ...
                @foreach($grid_right as $right)
                {
                    ...
                    "render": function(data, type, full, meta) {
                        ...
                        var titleValue = full.designation_name;
                ...
                },
                {
                    ...
                    "render": function(data, type, full, meta) {
                        ...
                        if(data!=null){
                            ...
                            return '<div class="text-left" onclick="return_message_history(\''+full.designation_name+'\',\''+full.id+'\',\'designations\')">'+data+'</div>';
                        }
                        else{
