        ...
        <table class="table table-bordered table-hover">
            ...
            <tbody>
                ...
                <tr data-widget="expandable-table" aria-expanded="false">
                    ...
                    <td>{{$single_data->ddesignation_code}}</td>
                    <td>{{isset($history_data->ddesignation_code)?$history_data->ddesignation_code:''}}</td>
                </tr>
                <tr data-widget="expandable-table" aria-expanded="false">
                    <td>Designation Title</td>
                    <td>{{$single_data->ddesignation_title}}</td>
                    <td>{{isset($history_data->ddesignation_title)?$history_data->ddesignation_title:''}}</td>
                </tr>
                <tr data-widget="expandable-table" aria-expanded="false">
                ...
                <tr data-widget="expandable-table" aria-expanded="false">
                    <td>Details</td>
                    <td><p>{!!$single_data->ddesignation_details!!}</p></td>
                    <td>{!!isset($history_data->ddesignation_details)?$history_data->ddesignation_details:''!!}</td>
                </tr>
                <tr data-widget="expandable-table" aria-expanded="false">
    ...
    function verify(){
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                all_response(response,'{{route(request()->route()->getName())}}','Verify View Designation');
            },
