            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="group_name" name="group_name" placeholder="Enter User Group Name" maxlength="100" onfocusout ="check_duplicate_value('group_name','user_groups',this.value,{{$single_data->id}});" value="{{$single_data->group_name}}" tabindex="1" autofocus>
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" maxlength="4" id="group_code" name="group_code" placeholder="Enter User Group Code" onfocusout ="check_duplicate_value('group_code','user_groups',this.value,{{$single_data->id}});" value="{{$single_data->group_code}}" tabindex="2">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" maxlength="100" id="group_title" name="group_title" placeholder="Enter User Group Title" value="{{$single_data->group_title}}" tabindex="3">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="group_details" maxlength="250" name="group_details" tabindex="4" >{!!$single_data->group_details!!}</textarea>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="hidden" name="hidden_group_logo" id="hidden_group_logo" value="{{$single_data->group_logo}}">
                        <span id="group_logo-error" class="error">Please Enter User Group Photo</span>
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="form-group">
                        <img class="rounded avatar-lg" width="80" height="80" id="group_logo_photo" src="{{asset('uploads/user_group')}}/{{$single_data->group_logo!=''?$single_data->group_logo:'user_group_logo.png'}}"/>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="hidden" name="hidden_group_icon" id="hidden_group_icon" value="{{$single_data->group_icon}}">
                        <span id="group_icon-error" class="error">Please Enter User Group Icon</span>
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="form-group">
                        <img class="rounded avatar-lg" width="80" height="80" id="group_icon_photo" src="{{asset('uploads/user_group')}}/{{$single_data->group_icon!=''?$single_data->group_icon:'user_group_icon.png'}}"/>
                    </div>
                </div>
            </div>
        </div>
        <div class="card-footer">
            <button type="button" onclick="validation();" class="btn btn-primary float-right" tabindex="7">Update User Group</button>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    ...
    function validation(){
        ...
        confirm_box('Edit', 'Are You Sure Want To Update User Group Info?','update_data');
    }
    ...
    function update_data(){
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                all_response(response,'{{route('user_management.user_group.view')}}','Edit View User Group');
            },
