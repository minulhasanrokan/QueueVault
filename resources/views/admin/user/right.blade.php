<div class="container-fluid">
    <div class="card card-default">
        ...
        <div class="card-footer">
            <button type="button" onclick="validation();" class="btn btn-primary float-right" >Update User Right</button>
        </div>
    </div>
</div>
<style type="text/css">
...
<script type="text/javascript">
    ...
    function validation(){
        ...
        confirm_box('User Right', 'Are You Sure Want To Update User Right?','update_right');
    }
    ...
    function update_right(){
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                all_response(response,'{{route(request()->route()->getName())}}','Right View Employee/User');
            },
