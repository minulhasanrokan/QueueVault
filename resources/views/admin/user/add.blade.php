<div class="container-fluid">
    <div class="card card-default">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="user_id" name="user_id" placeholder="Enter Employee/User ID" minlength="{{$system_data['userid_min_length']}}" maxlength="{{$system_data['password_max_length']}}" onfocusout ="check_duplicate_value('user_id','users',this.value,0);" value="" tabindex="1" autofocus>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" maxlength="100" id="name" name="name" placeholder="Enter Employee/User Name" value="" tabindex="2">
                ...
                <div class="col-md-8">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" maxlength="200" id="address" name="address" placeholder="Enter Employee/User Address" value="" tabindex="8">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" maxlength="11" id="mobile" name="mobile" placeholder="Enter Employee/User Modile" onfocusout ="check_duplicate_value('mobile','users',this.value,0);" value="" tabindex="9">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" maxlength="100" id="email" name="email" placeholder="Enter Employee/User E-mail" onfocusout ="check_duplicate_value('email','users',this.value,0);" value="" tabindex="10">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="details" maxlength="250" name="details" tabindex="12" ></textarea>
        ...
        <div class="card-footer">
            <button type="button" onclick="validation();" class="btn btn-primary float-right" tabindex="13">Add Employee/User</button>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    ...
    load_drop_down('user_groups','id,group_name','group_id','group_id_container','Select Employee/User Group',0,0,0,3,'',0,0,0,0);
    load_drop_down('branches','id,branch_name','branch_id','branch_id_container','Select Employee/User Branch',0,0,0,4,'',0,0,0,0);
    load_drop_down('departments','id,department_name','department','department_container','Select Employee/User Department',0,0,0,5,'',0,0,0,0);
    load_drop_down('departments','id,department_name','assign_department','assign_department_container','Select Employee/User Assign Department',1,0,0,6,'',0,0,0,0);
    load_drop_down('designations','id,designation_name','designation','designation_container','Select Employee/User Designation',0,0,0,7,'',0,0,0,0);
    ...
    function validation(){
        ...
        confirm_box('Add', 'Are You Sure Want To Save Employee/User Info?','add_data');
    }
    ...
    function add_data(){
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                all_response(response,'{{route('user_management.user.view')}}','View Employee/User');
            },
